...
export default function Quiz() {
  ...
  if (screen === "intro") {
    return (
      <div className="bg-white rounded-[16px] shadow-[0_20px_60px_rgba(0,0,0,0.35)] w-full max-w-[560px] p-10 text-center">
  ...
  if (screen === "quiz") {
    ...
    return (
      <div className="bg-white rounded-[16px] shadow-[0_20px_60px_rgba(0,0,0,0.35)] w-full max-w-[560px] p-8">
        {/* Progress */}
        <div className="mb-6">
